...
var peliculas = []; //Función tipo objeto
...
function Pelicula() {
  ...
  this.percentage = function () {
    return "".concat(this.people / this.capacity * 100);
  };
}
...
document.querySelector('#nueva').addEventListener('click', function () {
  ...
  var p1 = new Pelicula(pelicula[0], pelicula[1], pelicula[2], pelicula[3], pelicula[4]); // recuerden llamar las funciones de cartelera y listado
...
//# sourceMappingURL=/cine.e31bb0bc.js.map